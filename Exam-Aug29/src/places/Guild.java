...
public class Guild {
    private static final String ADD_COMMAND_SUCCESS = "Added heroes: ";

    private static final String ADD_COMMAND_UPDATE = "Updated heroes: ";
    ...
    public String removeHero(Hero hero){
        ...
        return String.format("Successfully removed heroes [%s] from guild %s", hero.getName(), this.name);
    }
